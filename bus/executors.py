...
async def run_chat_completation(input_data: Any) -> dict[str, Any]:
...
async def run_send_chat_history(input_data: Any) -> tuple[str, dict[str, Any]]:
...
async def enqueue_chat_completation(input_data: Any) -> dict[str, Any]:
...
async def enqueue_send_chat_history(input_data: Any) -> tuple[str, dict[str, Any]]:
